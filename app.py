...
with tab_db:
    ...
    with sub_tab1:
        ...
        with inst_tabs[0]:
            components.html(fetch_fubon_html("https://fubon-ebrokerdj.fbs.com.tw/Z/ZG/ZGK_D.djhtm"), height=1150, width=800, scrolling=True)
        with inst_tabs[1]:
            components.html(fetch_fubon_html("https://fubon-ebrokerdj.fbs.com.tw/Z/ZG/ZGK_DD.djhtm"), height=1150, width=800, scrolling=True)
        with inst_tabs[2]:
            components.html(fetch_fubon_html("https://fubon-ebrokerdj.fbs.com.tw/Z/ZG/ZGK_DB.djhtm"), height=1150, width=800, scrolling=True)
