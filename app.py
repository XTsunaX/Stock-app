...
with tab2:
    ...
    if not df_calc.empty:
        ...
        try:
            styled_calc = styled_calc.hide(axis="index")
        except:
            pass
            
        st.dataframe(styled_calc, use_container_width=False, hide_index=True, height=table_height)
